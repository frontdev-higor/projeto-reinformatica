 ...
 */
  ...
  document.addEventListener('shown.bs.tab', function (event) {
    ...
    localStorage.setItem('ultimaAbaMonitor', target);
 ...
 */
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const DEFAULT_TAB = "#pagina-sem-aba";
    ...
    if (window.location.hash) {
      ...
      tabId = localStorage.getItem("ultimaAbaMonitor") || DEFAULT_TAB;
    }
    ...
    if (trigger) {
      ...
      // salva corretamente
      localStorage.setItem("ultimaAbaMonitor", tabId);
    }
